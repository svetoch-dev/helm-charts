...
*/}}
{{- define "fluentbit-filters.fullname" -}}
...
*/}}
{{- define "fluentbit-filters.chart" -}}
...
Common labels
*/}}
{{- define "fluentbit-filters.labels" -}}
app.kubernetes.io/name: {{ include "fluentbit-filters.name" . }}
helm.sh/chart: {{ include "fluentbit-filters.chart" . }}
...
*/}}
{{- define "fluentbit-filters.serviceSelectorLabels" -}}
app.kubernetes.io/name: {{ .Release.Name }}-{{ include "fluentbit-filters.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}

{{- define "fluentbit-filters.redisExporterDefaults" -}}
