...
*/}}
{{- define "fluentbit-outputs.fullname" -}}
...
*/}}
{{- define "fluentbit-outputs.chart" -}}
...
Common labels
*/}}
{{- define "fluentbit-outputs.labels" -}}
app.kubernetes.io/name: {{ include "fluentbit-outputs.name" . }}
helm.sh/chart: {{ include "fluentbit-outputs.chart" . }}
...
*/}}
{{- define "fluentbit-outputs.serviceSelectorLabels" -}}
app.kubernetes.io/name: {{ .Release.Name }}-{{ include "fluentbit-outputs.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}

{{- define "fluentbit-outputs.redisExporterDefaults" -}}
