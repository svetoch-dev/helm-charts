...
*/}}
{{- define "fluentbit-inputs.fullname" -}}
...
Common labels
*/}}
{{- define "fluentbit-inputs.labels" -}}
app.kubernetes.io/name: {{ include "fluentbit-inputs.name" . }}
helm.sh/chart: {{ include "fluentbit-inputs.chart" . }}
...
*/}}
{{- define "fluentbit-inputs.serviceSelectorLabels" -}}
app.kubernetes.io/name: {{ .Release.Name }}-{{ include "fluentbit-inputs.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}

{{- define "fluentbit-inputs.redisExporterDefaults" -}}
