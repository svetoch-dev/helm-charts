...
do
  ...
  curl -s -o "${CRDS_VERSION}.${CRDS_NAME}" https://raw.githubusercontent.com/bitnami/charts/refs/tags/rabbitmq-cluster-operator/${CRDS_VERSION}/bitnami/rabbitmq-cluster-operator/crds/rabbitmq-cluster/${CRDS_NAME}
