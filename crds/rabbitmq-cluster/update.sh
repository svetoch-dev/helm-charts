...
do
  ...
  curl -L -s -o "${CRDS_VERSION}.${CRDS_NAME}" https://raw.githubusercontent.com/bitnami/charts/main/bitnami/rabbitmq-cluster-operator/crds/crd-rabbitmq-cluster.yaml
