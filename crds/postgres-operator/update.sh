...
do
  ...
  curl -L -s -o "${CRDS_VERSION}.${CRDS_NAME}" https://raw.githubusercontent.com/zalando/postgres-operator/${CRDS_VERSION}/charts/postgres-operator/crds/${CRDS_NAME}
