...
do
  ...
  curl -s -o "${CRDS_VERSION}.${CRDS_NAME}" https://raw.githubusercontent.com/grafana/grafana-operator/refs/tags/${CRDS_VERSION}/deploy/helm/grafana-operator/files/crds/${CRDS_NAME}
