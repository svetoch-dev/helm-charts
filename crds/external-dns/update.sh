...
do
  ...
  curl -s -o "${CRDS_VERSION}.${CRDS_NAME}" https://raw.githubusercontent.com/kubernetes-sigs/external-dns/${CRDS_VERSION}/docs/sources/crd/${CRDS_NAME}
